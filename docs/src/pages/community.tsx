          ...
          <div className="row margin-vert--lg">
            <div className="col text--center padding-vert--md">
              <div className="card">
                ...
                <div className="card__footer">
                  <Link to="https://github.com/samber/ro/issues" className="button button--outline button--primary button--block">Open new issue</Link>
                </div>
              </div>
            </div>
            ...
            <div className="col text--center padding-vert--md">
              <div className="card">
                ...
                <div className="card__footer">
                  <Link to="https://github.com/samber/ro?tab=readme-ov-file#-contributing" className="button button--outline button--primary button--block">Start contributing!</Link>
                </div>
              </div>
            </div>
