Apache 2.0 License (The "Community License")
Copyright (c) 2025-present Samuel Berthe.

Portions of this software are licensed as follows:

- All content that resides under the "ee/" directory of this repository, if that directory exists, is licensed under the license defined in "licenses/LICENSE.ee.md".
